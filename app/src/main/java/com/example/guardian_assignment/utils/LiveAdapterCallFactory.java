...
public class LiveAdapterCallFactory extends CallAdapter.Factory {
     ...
     * CHECK #3) Make sure ApiResponse is parameterized. ApiResponse<T> exists.
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        // Check #3
        // Check if ApiResponse is parameterized.Does ApiResponse<T> exists? (must wrap around T)
